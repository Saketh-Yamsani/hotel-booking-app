...
const Signin=()=>{
    ...
    const {register,formState:{errors},handleSubmit}=useForm<SigninFomrData>();
    ...
    return(
        <form className="flex flex-col gap-5" onSubmit={onSubmit}>
            ...
            <label className="text-gray-700 text-sm font-bold flex-1">
                    Email
                    <input 
                    type="email" className="border rounded w-full py-1 px-2 font-normal"
